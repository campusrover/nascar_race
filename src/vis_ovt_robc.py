...
class Visual_Overtake_Monitor:
    def __init__(self,turtlename):
        ...
        self.image_sub = rospy.Subscriber("robc/raspicam_node/image/compressed", CompressedImage, self.image_callback)
        self.ovt_pub = rospy.Publisher("robc/overtake", String, queue_size=1)
        self.ovt_pub_2 = rospy.Publisher("rafael/overtake", String, queue_size=1)
